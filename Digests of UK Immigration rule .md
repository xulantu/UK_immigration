...
### Leave can be extended by a valid or invalid application, which afterwards is validated or amended.

From Guidance 3C and 3D leave, [https://www.gov.uk/government/publications/3c-and-3d-leave/3c-and-3d-leave-accessible](https://www.gov.uk/government/publications/3c-and-3d-leave/3c-and-3d-leave-accessible), accessed 2026-01-31

Quote:  
Where an application is received that is invalid and a fee has been paid, even if it is the wrong fee, the Validation, variation and withdrawal of applications guidance provides that the Home Office will write out and provide a single opportunity to correct any omission or error. The person is given 10 working days to respond to the request.
...
From Guidance Vary your immigration application, [https://www.gov.uk/guidance/vary-your-immigration-application](https://www.gov.uk/guidance/vary-your-immigration-application), accessed 2026-01-31
...
### The fees and rules that are applicable for variation of an application is decided by the date of the new application. The only exception is for section 3C purposes, where the relevant date would be the old date.

From Guidance Validation, variation, voiding and withdrawal of applications, [https://www.gov.uk/government/publications/specified-application-forms-and-procedures/validation-variation-voiding-and-withdrawal-of-applications-accessible](https://www.gov.uk/government/publications/specified-application-forms-and-procedures/validation-variation-voiding-and-withdrawal-of-applications-accessible), accessed 2026-01-31

Quote:  
Where an application is varied, the application date remains the date of the original application. There is an exception to this for dependants (see below). This is relevant to whether an applicant has, or will have, their leave extended under section 3C. For further information see: 3C and 3D leave. For the purposes of assessment against the rules, the relevant date is the date the variation application is made.

From Immigration Rules, [https://www.gov.uk/guidance/immigration-rules/immigration-rules-part-1-leave-to-enter-or-stay-in-the-uk](https://www.gov.uk/guidance/immigration-rules/immigration-rules-part-1-leave-to-enter-or-stay-in-the-uk), accessed 2026-01-31
...
### Skilled worker can apply for a visa (leave to enter or remain) at most 3 months after the issuance of CoS and at most 3 months before the first day of the CoS

From Immigration Rules, [https://www.gov.uk/guidance/immigration-rules/immigration-rules-appendix-skilled-worker](https://www.gov.uk/guidance/immigration-rules/immigration-rules-appendix-skilled-worker), accessed 2026-01-31
...
(d) the applicant must have a certificate of sponsorship that was issued to them by their sponsor no more than 3 months (or 90 days, where the Certificate of Sponsorship is linked to a Sponsorship Reference Number, disregarding any days during which an edit requested by a sponsor to their Sponsor a Worker submission is being reviewed) before the date of application.
...
(c) include a start date, stated by the sponsor, which is no more than 3 months after the date of application;
...
Quote:  
S3.11. The worker must use the CoS in an application for entry clearance or permission no more than 3 months after the date it was assigned to them. However, they cannot apply for entry clearance or permission more than 3 months in advance of their employment start date, as stated on their CoS.

### Period of visa grant: from the approval date to 14 days after end of CoS

From Guidance Workers and Temporary Workers: sponsor a skilled worker, [https://www.gov.uk/government/publications/workers-and-temporary-workers-sponsor-a-skilled-worker/workers-and-temporary-workers-sponsor-a-skilled-worker-accessible](https://www.gov.uk/government/publications/workers-and-temporary-workers-sponsor-a-skilled-worker/workers-and-temporary-workers-sponsor-a-skilled-worker-accessible), accessed 2026-01-31
...
\-   the period of employment stated on their CoS (you can assign a CoS for a maximum period of 5 years), plus:  
\-   any time before the start date on the CoS (an application can be made up to 3 months before the start date)  
\-   14 days after the end date on the CoS (or, where the worker is being sponsored under occupation code 2211 as a general practitioner in specialty training, 4 months after the end date on their CoS)
...
### In-country biometrics needs to be enrolled within 45 working days

From Guidance Biometric enrolment: policy guidance, [https://www.gov.uk/government/publications/biometric-information/biometric-information-enrolment-accessible](https://www.gov.uk/government/publications/biometric-information/biometric-information-enrolment-accessible), accessed 2026-01-31
